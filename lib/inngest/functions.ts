...
export const summarizeFile = inngest.createFunction(
  { id: 'task-summarize-file-openai', name: 'Task: Summarize File (OpenAI)', retries: 3, concurrency: { limit: 10 } },
...
export const processDocument = inngest.createFunction(
  { id: 'task-process-document-openai', name: 'Task: Process Document (OpenAI)', retries: 2, concurrency: { limit: 5 } },
...
export const summarizeDocument = inngest.createFunction(
  { id: 'task-summarize-document-openai', name: 'Task: Summarize Document (Legacy, OpenAI)', retries: 3 },
